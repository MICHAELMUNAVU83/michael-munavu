    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5  gap-8 pt-5">
        <div className="col-span-4">
          ...
          <p>
            This is a developer's social events booking app built with React JS
            and Ruby on Rails for database management. It allows users to book a
            seat at an event and also allows the admin to create events.
          </p>
