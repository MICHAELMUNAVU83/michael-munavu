...
const ProjectItem = ({ title, image, projectUrl, languages }) => {
  return (
    <div className="relative flex items-center justify-center h-80 w-full shadow-xl shadow-gray-400 rounded-xl px-2 py-4 group hover:bg-gradient-to-r from-[#5651e5] to-[#00b4db]/50 ease-in-out duration-500">
      <Image
