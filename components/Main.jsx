        ...
        <div className="max-w-[1240px] mx-auto h-full flex p-2 justify-center items-center">
          <div>
            ...
            <p className=" kulim-park py-4 text-gray-600 max-w-[85%] m-auto">
              ...
              From small to large-scale projects, I have used React , Elixir ,
              Phoenix and Ruby on Rails to create solutions that delight users
              and drive results. So why settle for less when you can have the
