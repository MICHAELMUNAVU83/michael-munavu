        ...
        <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
          <div className="col-span-2">
            ...
            <p className="py-2 text-gray-600">
              ...
              <span className=" text-[#5651e5]">past 3 years</span> and a
              graduant from <span className=" text-[#5651e5]">Microverse,</span>{" "}
              a remote International learning institution where I learned
              through pair programming and project building. We worked on many
              ...
              <span className=" text-[#5651e5]">Moringa School</span> which is
              the top programming school in Kenya.
            </p>

            <p className="py-2 text-gray-600">
              I have been part of a team that won two{" "}
              <span className=" text-[#5651e5]">
                Hackathons in the past year
              </span>{" "}
            ...
            <p className="py-2 text-gray-600">
              ...
              <span className=" text-[#5651e5]">write technical articles</span>{" "}
              on React and Ruby on Rails mostly on{" "}
              <span className=" text-[#5651e5]">
                <a
